    ...
    return (
        <footer class="bg-green-50 border-t border-green-300 shadow-md">
            <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span class="block md:text-sm text-xs sm:text-center ">© 2024 <a href="https://flowbite.com/" class="hover:underline">DietasBalance</a>. Todos los derechos reservados.</span>
            </div>
        </footer>
    );
};
