...
const Hidratate = () => {
    return (
        <div className="bg-gray-100">
            <Helmet>
                <title>Dietas Balance - Beber Agua.</title>
                <meta name="description" content="Uno de los principales consejos para llevar una vida saludable y llena de energía es hidratarse bebiendo suficiente agua." />
            </Helmet>
            <Nav />
