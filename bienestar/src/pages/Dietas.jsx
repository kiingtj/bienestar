        ...
        <div className="bg-gray-100">
            ...
            <main className="max-w-7xl mx-auto py-10 px-4">
                <section className="text-center py-10">
                    <h1 className="text-5xl font-bold text-green-700 mb-4">6 Tipos de Dietas Saludables</h1>
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-8">
                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <img src="/images/dietas/mediterranea.jpg" alt="Dieta Mediterránea" className="h-40 w-full object-cover rounded-md mb-4" />
                        ...
                        <Link to="/mediterranea">
                            <p className="text-green-600 font-semibold">Más detalles &rarr;</p>
                        </Link>
                    </div>

                    <div className="bg-white p-4 rounded-lg shadow-md">
                        <img src="/images/dietas/keto.jpg" alt="Dieta Keto" className="h-40 w-full object-cover rounded-md mb-4" />
                    ...
                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <img src="/images/dietas/vegana.jpg" alt="Dieta Vegana" className="h-40 w-full object-cover rounded-lg mb-4" />
                        ...
                        <a href="#vegana" className="text-green-600 font-semibold">Más detalles &rarr;</a>
                    </div>

                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <img src="/images/dietas/paleo.jpg" alt="Dieta Paleo" className="h-40 w-full object-cover rounded-lg mb-4" />
                        ...
                        <a href="#paleo" className="text-green-600 font-semibold">Más detalles &rarr;</a>
                    </div>

                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <img src="/images/dietas/dash.jpg" alt="Dieta DASH" className="h-40 w-full object-cover rounded-lg mb-4" />
                        ...
                        <a href="#dash" className="text-green-600 font-semibold">Más detalles &rarr;</a>
                    </div>

                    <div className="bg-white p-6 rounded-lg shadow-md">
                        <img src="/images/dietas/flexitariana.jpg" alt="Dieta Flexitariana" className="h-40 w-full object-cover rounded-lg mb-4" />
                        ...
                        <a href="#flexitariana" className="text-green-600 font-semibold">Más detalles &rarr;</a>
                    </div>
                </section>
                ...
                <section className="py-16">
                    <h2 className="text-4xl font-bold text-green-700 text-center mb-8">Consejos para Mantener una Alimentación Saludable</h2>
